...
const ScheduleSession = () => {  
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [params.schedule_id, params.subject_id, adminUserId]);
  ...
  return (
    <>
    <SidebarProvider>
      <AppSidebarAdmin userId={adminUserId} />
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center justify-between gap-2 sticky top-0 bg-white z-10 px-2 sm:px-4 border-b">
            <div className="flex items-center gap-2">
                ...
                <BreadcrumbList>                        
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/admin/class-management">
                              Class Management
                            </BreadcrumbLink>
                        </BreadcrumbItem>                          
                        <BreadcrumbSeparator>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink href={`/admin/class-management/current/class-details/${params.subject_id}`}>
                              Details
                            </BreadcrumbLink>
                        </BreadcrumbItem>    
                        <BreadcrumbSeparator>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink href={`/admin/class-management/current/class-details/${params.subject_id}/${params.schedule_id}`}>
                              Schedule
                            </BreadcrumbLink>
                        </BreadcrumbItem> 
                    </BreadcrumbList>            
