...
const SubjectDetails = () => {
  ...
  const viewScheduleSession = async (schedule_id: number) => {
    ...
    await router.push(`/admin/class-management/class-details/${classSubject.id}/${schedule_id}`)      
  }
            ...
            <div className="flex items-center gap-2">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink href={`/admin/class-management/class-details/${params.subject_id}`}>
                              Details
                            </BreadcrumbLink>
                        </BreadcrumbItem>         
                    </BreadcrumbList>              
